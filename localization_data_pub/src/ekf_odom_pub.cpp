...
const double TICKS_PER_REVOLUTION = 3000; // For reference purposes.
const double WHEEL_RADIUS = 0.0575; // Wheel radius in meters
const double WHEEL_BASE = 0.285; // Center of left tire to center of right tire
const double TICKS_PER_METER = 8000; // Original was 2800
