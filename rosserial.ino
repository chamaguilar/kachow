...
Ultrasonic leftSonar(24, 25, 100000UL);
Ultrasonic centerSonar(26, 27, 100000UL);
Ultrasonic rightSonar(28, 29, 100000UL);
...
ros::Publisher sonarPub("sonar", &scan);
...
void loop() {
  ...
  if (currentMillis - previousMillis > interval) {
    ...
    valRanges[0] = rightSonar.read() / 100.0;
    valRanges[1] = centerSonar.read() / 100.0;
    valRanges[2] = leftSonar.read() / 100.0;
